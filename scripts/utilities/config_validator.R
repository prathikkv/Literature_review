...
load_and_validate_config <- function(config_file = "config_dynamic_pipeline.yml", strict_mode = TRUE) {
...
validate_config_quick <- function(config_file = "config_dynamic_pipeline.yml") {
...
# Auto-validate if run as script
